<%@ Page Title="" Language="C#" MasterPageFile="~/Store.Master" AutoEventWireup="true" CodeBehind="NewViewTrendForEachDept.aspx.cs" Inherits="LogicUniversityWebLogic.NewViewTrendForEachDept" %>
...
<table>
        <tr><td>
            <asp:Label ID="Label1" runat="server" Text="Department :"></asp:Label></td><td>  <asp:DropDownList ID="ddlDeptName" runat="server" Height="25px" Width="224px">
                     </asp:DropDownList>
            </td><td></td></tr>
        ...
        <tr><td>
            <asp:Label ID="Label2" runat="server" Text="Current Month :"></asp:Label></td><td>
        ...
        <tr><td>
            <asp:Label ID="Label3" runat="server" Text="Previous Months :"></asp:Label></td><td>
        ...
        <tr><td></td><td>
            ...
            <asp:ListItem Value="12">Dec</asp:ListItem>
             ...
             <tr><td><asp:Label ID="Label4" runat="server" Text="Status"></asp:Label></td><td>
        ...
        <tr><td colspan="3">
            <asp:Button ID="btnViewRpt" runat="server" Text="View Report" 
                onclick="btnViewRpt_Click" /></td></tr>
        </table>
