    ...
    public partial class Employee_Requisition : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                TempTableforitem();
                //Session["loginUser"] = "1001";// To update login id
            }
        }
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            if (gvRequestDetail.Rows.Count > 0)
            {
                ...
                if (btnSubmit.Text == "Submit")
                {
                    ...
                    ScriptManager.RegisterStartupScript(UpdatePanel2, UpdatePanel2.GetType(), "Information", script, true);
                }
                else
                {
        ...
        protected void gvRequestDetail_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            Button updatebutton = (Button)gvRequestDetail.Rows[e.RowIndex].FindControl("btnEdit");
