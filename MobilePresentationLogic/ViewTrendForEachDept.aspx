<%@ Page Title="" Language="C#" MasterPageFile="~/Store_Master.Master" AutoEventWireup="true" CodeBehind="ViewTrendForEachDept.aspx.cs" Inherits="LogicUniversityWebLogic.ViewTrendForEachDept" %>
...
<table>
        ...
        <tr><td><asp:Label ID="Label3" runat="server" Text="Previous Months :" /></td><td>
            <asp:DropDownList ID="ddlPastMonth" runat="server" Height="25px" 
                Width="71px">
            <asp:ListItem Value="1">Jan</asp:ListItem>
            <asp:ListItem Value="2">Feb</asp:ListItem>
            <asp:ListItem Value="3">Mar</asp:ListItem>
        ...
        <tr><td style="width:200px">
            <CR:CrystalReportViewer ID="rptDeptTrendView" runat="server" AutoDataBind="true" />
        </td></tr>
        </table>
